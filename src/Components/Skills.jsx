...
const skills = [
    ...
    { id: 3, name: 'HTML & CSS', level: '90%', icon: <FaHtml5 /> },
    { id: 4, name: 'MySQL', level: '80%', icon: <SiMysql /> },
    { id: 5, name: 'MongoDB', level: '80%', icon: <SiMongodb /> },
    { id: 6, name: 'Bootstrap', level: '90%', icon: <FaBootstrap /> },
    { id: 7, name: 'Express.js', level: '80%', icon: <SiExpress /> },
    { id: 8, name: 'Node.js', level: '80%', icon: <FaNodeJs /> },
